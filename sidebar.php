      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index.php" class="brand-link">
          ...
          <span class="brand-text font-weight-light">PROJECT1</span>
        </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="dist/img/mila-foto.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Mila Lestari</a>
        </div>
      </div>
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item">
                        <a href="form_nilai2.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Praktikum 2.2</p>
                        </a>
                      </li>
                  ...
                  <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="form_nilaii.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Praktikum 3.1</p>
                        </a>
                      </li>
                  ...
                  <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="class_buah.php" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Praktikum 5.1</p>
                        </a>
                      </li>
